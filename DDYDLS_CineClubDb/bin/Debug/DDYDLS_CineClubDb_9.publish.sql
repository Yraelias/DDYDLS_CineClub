...
GO
/*
La colonne [dbo].[T_User].[Language] est en cours de suppression, des données risquent d'être perdues.
*/
...
GO
PRINT N'Modification de Table [dbo].[T_User]...';


GO
ALTER TABLE [dbo].[T_User] DROP COLUMN [Language];
